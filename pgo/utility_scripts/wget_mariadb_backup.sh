...
URL_LOCATION="https://obf.mkrsvr.org/$LONG_DIRECTORY/mariadb_backup_$(date +%F).sql.gz.enc"
...
SAVE_LOCATION="$HOME/trustnet/pgo/mariadb_restores/mariadb_backup_$(date +%F).sql.gz.enc"
