...
#my $test = '{"fingerprint":"8774e15f162f4e3a8f03bc7d4c5845bf9bee9bc9c4155802366f90ae92b47c90","data":""}';
	...
	if ($server_type ne "main") {
		...
		add_log_message("ERROR: STORE DENIED: THIS SERVER ISN'T MAIN!");
		exit 0;
	}
	...
	add_log_message("Total stores today: $total_stores_today");
	...
	add_log_message("Stores today: $stores_today for IP: $ip");
	if ($stores_today >= 100) {
		...
		if ($store_response == 1 or $store_response == 2) {
			# Store succeeded.
			add_log_message("store_response: $store_response");
